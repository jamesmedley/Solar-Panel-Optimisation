...
public class Error {
    ...
    public void sendError(String error){//Creates a JOptionPane that can display to the user that there has been an error. The parameter holds a string with a message to display on the error window.
        ERRORSOUND.run();
        FRAME = new JFrame();
